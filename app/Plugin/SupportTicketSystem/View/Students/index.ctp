...
<div class="students index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('',true), array('action' => 'edit', $student['Student']['id']),array('class' => 'glyphicon glyphicon-edit')); ?>
			<?php echo $this->Form->postLink(__('',true), array('action' => 'delete', $student['Student']['id']),array('class' => 'glyphicon glyphicon-remove' => false), null, __('Are you sure you want to delete # %s?', $student['Student']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

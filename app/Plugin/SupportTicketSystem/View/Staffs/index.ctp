...
<div class="staffs index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('',true), array('action' => 'view', $staff['Staff']['id']),array('class' => 'glyphicon glyphicon-search')); ?>
			<?php echo $this->Html->link(__('',true), array('action' => 'edit', $staff['Staff']['id']),array('class' => 'glyphicon glyphicon-edit')); ?>
			<?php echo $this->Form->postLink(__('',true), array('action' => 'delete', $staff['Staff']['id']),array('class' => 'glyphicon glyphicon-remove' => false),null, __('Are you sure you want to delete # %s?', $staff['Staff']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

...
public $validate = array(
        'company_master_id' => array(
                'rule' => array ('validateUnique', array('company_master_id','institution_id','academic_year_id'))
            ),
        );

public $belongsTo = [
               'TrainingAndPlacement.Institution',
               'TrainingAndPlacement.Department',
               'TrainingAndPlacement.Degree',
               'TrainingAndPlacement.AcademicYear',
               'TrainingAndPlacement.CompanyMaster'

        ];
 
public $hasMany = [
               'TrainingAndPlacement.PlacementResult'
        ];
